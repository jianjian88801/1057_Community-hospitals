<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="检查时间" prop="jianchashijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jianchashijian" 
                type="datetime"
                placeholder="检查时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jianchashijian" label="检查时间" prop="jianchashijian">
              <el-input v-model="ruleForm.jianchashijian" 
                placeholder="检查时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="检查结果" prop="jianchajieguo">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jianchajieguo" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianchajieguo" label="检查结果" prop="jianchajieguo">
                    <span v-html="ruleForm.jianchajieguo"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.jianchashijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nianling = true;
          ...
          if(o=='jianchashijian'){
            this.ruleForm.jianchashijian = obj[o];
	    this.ro.jianchashijian = true;
            continue;
          }
          if(o=='jianchaxiangmu'){
	...
	this.ruleForm.jianchajieguo = this.ruleForm.jianchajieguo.replace(reg,'../../../springbootf5kdg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jianchajieguo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianchajieguoCrossAddOrUpdateFlag = false;
                  this.parent.search();
