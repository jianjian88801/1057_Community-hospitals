  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yaopinbianhao" label="药品编号" prop="yaopinbianhao">
              <el-input v-model="ruleForm.yaopinbianhao" 
                placeholder="药品编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生产地址" prop="shengchandizhi">
          <el-input v-model="ruleForm.shengchandizhi" 
              placeholder="生产地址" clearable  :readonly="ro.shengchandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生产地址" prop="shengchandizhi">
              <el-input v-model="ruleForm.shengchandizhi" 
                placeholder="生产地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品进价价格" prop="yaopinjinjiajiage">
          <el-input v-model="ruleForm.yaopinjinjiajiage" 
              placeholder="药品进价价格" clearable  :readonly="ro.yaopinjinjiajiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品进价价格" prop="yaopinjinjiajiage">
              <el-input v-model="ruleForm.yaopinjinjiajiage" 
                placeholder="药品进价价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	yaopinjinjiajiage : false,
      ...
      rules: {
          ...
          yaopinjinjiajiage: [
                { required: true, message: '药品进价价格不能为空', trigger: 'blur' },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baozhiqi = true;
          ...
          if(o=='yaopinjinjiajiage'){
            this.ruleForm.yaopinjinjiajiage = obj[o];
	    this.ro.yaopinjinjiajiage = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yaopinjinjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaopinjinjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
